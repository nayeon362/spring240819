package com.kny.springbasic.provider;
...
public class JwtProvider {
    ...
    // JMT 암호화에 사용되는 비밀키는 보안 관리가 되어야함
    ...
    // - @Value()를 이용하여 값을 가져옴
    // - 유의사항 : application.properties / application.yaml을 .gitignore에 등록해야함
    ...
    public String create(String name) {
        ...
        // JWT의 만료일자 및 시간
        Date expriedDate = Date.from(Instant.now().plus(4, ChronoUnit.HOURS));

        // 비밀키 생성
        // String secretKey =
        // "qwertyuiopasdfghjkl1234567890123456789012345678901234567890";
