package com.kny.springbasic.entity;
...
// - 웹 애플리케이션 서버와 데이터베이스 서버 간의 데이터 전송을 위한 객체
...
// - 이름이 서로 다르면 name속성으로 매핑할 table명을 지정할 수 있음
...
public class SampleTable1Entity {
    ...
    @Column(name = "sample_column", nullable = false, unique = true, updatable = false)
