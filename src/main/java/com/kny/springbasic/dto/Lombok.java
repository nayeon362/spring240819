...
public class Lombok {
    ...
    // 기본형 boolean 일 경우 getter 메서드 이름은 isXXX()
    private boolean field4;
    // 참조형 Boolena일 경우 getter 메서드 이름은 getXXX(0)
